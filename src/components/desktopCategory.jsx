...
import DesktopTableRow from './ProductTables/DesktopTableRow';
...
class Desktop extends Component {
    ...
    //   async searchProduct() {
    //     let {data} = await axios.get('http://localhost:5000/api/desktop/'+this.props.match.params.id);
    //     console.log(data);
    ...
    //   }
      ...
      tabRow() {
          return this.state.allProducts.map(function(object, i){
              return<DesktopTableRow obj={object} key={i}/>
          });
        }
                  ...
                  <div>
                    ...
                    <h3 align="center"><u> Desktop Item List</u></h3>&nbsp;&nbsp;&nbsp;&nbsp;
                       <div className="input-group mb-3">
                          ...
                          <Link to={"/AddProducts/addDesktops"} className="btn btn-primary">Add Desktop</Link> 
                        </div>
